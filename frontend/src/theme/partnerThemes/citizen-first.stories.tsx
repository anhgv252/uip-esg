...
import { citizenFirstThemeConfig } from './citizen-first.theme'

const theme = createPartnerTheme(citizenFirstThemeConfig)

const meta: Meta = {
  title: 'Themes/Citizen First',
  decorators: [
    (Story) => (
  ...
  render: () => (
    <Box p={3} maxWidth={400}>
      <Typography variant="h5" gutterBottom fontWeight={600}>
        {citizenFirstThemeConfig.partnerName}
      </Typography>
          ...
          <Stack spacing={2}>
            ...
            <Box bgcolor="primary.main" p={2} borderRadius={1}>
              <Typography color="primary.contrastText">
                Sidebar BG: {citizenFirstThemeConfig.sidebarBg}
              </Typography>
            </Box>
          </Stack>
        </CardContent>
