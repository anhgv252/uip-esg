...
export interface paths {
    ...
    "/api/v1/admin/tenants/{tenantId}/users/{userId}/role": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/api/v1/push/test": {
        ...
        get?: never;
        put?: never;
        /** Send a test push notification (non-production only) */
    ...
    "/api/v1/auth/logout": {
        ...
        get?: never;
        put?: never;
        /** Logout — clear httpOnly cookie and invalidate token */
    ...
    "/api/v1/admin/workflow-configs/{id}/test": {
        ...
        get?: never;
        put?: never;
        /** Test trigger with sample payload — dry run, no process started */
    ...
    "/api/v1/admin/tenants/{tenantId}/users/invite": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/api/v1/admin/errors/{id}/resolve": {
        ...
        post: operations["resolveAdminError"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/workflows": {
        ...
        /** List workflow definitions (AI Designer) */
    ...
    "/api/v1/workflows/{id}/deploy": {
        ...
        get?: never;
        put?: never;
        /** Deploy workflow to Camunda engine */
        post: operations["deployWorkflow"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/esg/reports/{id}/download": {
        ...
        /** Download ESG report (XLSX or CSV) */
    ...
    "/api/v1/esg/reports/pdf": {
        ...
        get?: never;
        put?: never;
        /** Generate GRI 302-1/305-4 ESG PDF report — synchronous, <30s SLA */
        post: operations["generatePdfReport"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/environment/aqi/history": {
        ...
        /** AQI history — optionally filtered by district and period (24h/7d/30d) */
    ...
    "/api/v1/buildings/{id}/safety": {
        ...
        /** Get safety score for a building */
        get: operations["getBuildingSafety"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/buildings/{id}/vibration/readings": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /** Get structural sensor readings for a building (24h trend) */
        get: operations["getVibrationReadings"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/mobile/auth/config": {
        ...
        /** Get mobile authentication configuration for a tenant */
        get: operations["getMobileAuthConfig"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/dashboard/stats": {
        ...
        /** Get dashboard stats (alias for /dashboard) */
    ...
    "/api/v1/bms/devices": {
        ...
        /** List BMS devices for current tenant */
        get: operations["listBmsDevices"];
        put?: never;
        /** Register a new BMS device */
        post: operations["createBmsDevice"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/bms/devices/{id}": {
        ...
        /** Get BMS device by ID */
        get: operations["getBmsDevice"];
        /** Update BMS device configuration */
        put: operations["updateBmsDevice"];
        post?: never;
        /** Delete a BMS device */
        delete: operations["deleteBmsDevice"];
        options?: never;
        head?: never;
        patch?: never;
        trace?: never;
    };
    "/api/v1/bms/devices/discover": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        get?: never;
        put?: never;
        /** Discover BMS devices on the local network via broadcast */
        post: operations["discoverBmsDevices"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/bms/devices/{id}/commands": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        put?: never;
        /**
         * Send actuator command to BMS device
         * @description Send a control command to a Building Management System device. **Requires OPERATOR role**. All commands are audit-logged.
         */
        post: operations["sendBmsDeviceCommand"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface components {
    schemas: {
        ...
        PageWorkflowSummaryDto: {
            content?: components["schemas"]["WorkflowSummaryDto"][];
            /** Format: int64 */
            totalElements?: number;
            /** Format: int32 */
            totalPages?: number;
        ...
        BmsCommandRequest: {
            /**
             * @description Type of BMS actuator command
             * @enum {string}
             */
            commandType: "SET_SETPOINT" | "TURN_ON" | "TURN_OFF" | "RESET_ALARM" | "ADJUST_SPEED";
            /** @description Command-specific parameters (e.g. { 'value': 22.5 } for SET_SETPOINT) */
            parameters: {
                [key: string]: unknown;
            };
            /** @description Audit trail reason for the command */
            reason?: string;
        };
        BmsCommandResponse: {
            /** Format: uuid */
...
export interface operations {
    ...
    getConfig: {
        ...
        responses: {
            ...
            /** @description Bad Request — validation error or malformed request body */
            400: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    listWorkflows: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "*/*": components["schemas"]["PageWorkflowSummaryDto"];
                };
            };
            /** @description Bad Request — validation error or malformed request body */
            400: {
    ...
    generatePdfReport: {
        ...
        responses: {
            ...
            200: {
                headers: {
                    /** @description attachment; filename="esg-report-Q{quarter}-{year}.pdf" */
            ...
            /** @description Missing esg:write scope or ADMIN role */
            403: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    getVibrationReadings: {
        ...
        requestBody?: never;
        responses: {
            /** @description Vibration readings */
            200: {
                headers: {
                    [name: string]: unknown;
                };
                content: {
                    "application/json": components["schemas"]["VibrationReadingResponse"][];
                };
            };
            /** @description Bad Request — validation error or malformed request body */
            400: {
    ...
    getMobileAuthConfig: {
        ...
        requestBody?: never;
        responses: {
            /** @description Mobile auth configuration */
            200: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    streamAlerts: {
        ...
        requestBody?: never;
        responses: {
            /** @description SSE stream of alert events */
            200: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    queryAlerts: {
        parameters: {
            query?: {
                ...
                page?: number;
                size?: number;
                /** @description Filter by source module (e.g. ENVIRONMENT, TRAFFIC, FLOOD, BMS) */
                module?: string;
            };
            header?: never;
            path?: never;
    ...
    listUsers_1: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "*/*": components["schemas"]["TenantUserDto"][];
                };
            };
            /** @description Bad Request — validation error or malformed request body */
            400: {
    ...
    getUsage: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "*/*": components["schemas"]["TenantUsageDto"];
                };
            };
            /** @description Bad Request — validation error or malformed request body */
            400: {
    ...
    listBmsDevices: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["BmsDeviceResponse"][];
                };
            };
            /** @description Bad Request — validation error or malformed request body */
            400: {
    ...
    createBmsDevice: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["BmsDeviceRequest"];
            };
        };
        responses: {
            /** @description Created */
    ...
    sendBmsDeviceCommand: {
        parameters: {
            query?: never;
            header?: never;
            path: {
                /** @description BMS device identifier */
                id: string;
            };
            cookie?: never;
        };
        requestBody: {
            content: {
                "application/json": components["schemas"]["BmsCommandRequest"];
            };
        };
        responses: {
            ...
            202: {
                ...
                content: {
                    "application/json": components["schemas"]["BmsCommandResponse"];
                };
            };
            ...
            /** @description Insufficient permissions — OPERATOR role required */
            403: {
                headers: {
                    [name: string]: unknown;
                };
